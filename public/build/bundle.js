    ...
    function create_left_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(textarea, file$1, 14, 12, 330);
    			attr_dev(left, "slot", "left");
    			attr_dev(left, "class", "svelte-mcy1vy");
    			add_location(left, file$1, 13, 8, 298);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_right_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$1, 17, 8, 487);
    			attr_dev(right, "slot", "right");
    			attr_dev(right, "class", "svelte-mcy1vy");
    			add_location(right, file$1, 16, 8, 458);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_top_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 19, 2, 482);
    			attr_dev(top, "slot", "top");
    			attr_dev(top, "class", "svelte-yncc30");
    			add_location(top, file, 18, 2, 463);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_down_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(down, file, 24, 2, 542);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 12, 2, 357);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
